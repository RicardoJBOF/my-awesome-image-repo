    ...
    <div>
      ...
      <Container className="p-3">
        ...
        <form className='Registration-form' onSubmit={handleSubmit(onSubmit)}>
          ...
          <input className="left-padding" type="text" name="first_name" ref={register({ required: true})} />
          {errors.first_name && <p className="Error-message"> This is a mandatory field. </p>}
        
          <label>Last Name:</label>
          <input className="left-padding" type="text" name="last_name" ref={register({ required: true})}  />
          {errors.last_name && <p className="Error-message"> This is a mandatory field. </p>}

          <label>Email:</label>
          <input className="left-padding" type="email" name="email" ref={register({ required: true})}  />
          {errors.email && <p className="Error-message"> This is a mandatory field. </p>}

          <label>Password:</label>
          <input className="left-padding" type="password" name="password" ref={register({ required: true, minLength: 6})}  />
          ...
          <input className="left-padding" type="password" name="check_password" ref={register({ validate: (value) => value === watch('password') })}  />
